...
// remove entry point from config and let them be replaced by the karma files property.
webpackConfig.entry = {};
...
module.exports = function(config) {
    config.set({
        ...
        preprocessors: {
            'dev/test/test-main.js': ['webpack', 'sourcemap'] // use this for source maps
                // 'dev/test/test-main.js': ['webpack']
        },
